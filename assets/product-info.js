      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          const updateSourceFromDestination = (id, shouldHide = (source) => false) => {
            ...
            // Scope to main product only - exclude complementary products and add-ons
            // This prevents price updates from overwriting add-on/complementary product prices
            // Note: Using .card-wrapper (the actual DOM class), not .card-product (snippet filename)
          ...
          // Kondasoft
          updateSourceFromDestination('ks-product-quantity-breaks')
          // /Kondasoft
